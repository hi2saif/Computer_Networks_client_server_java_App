...
public class Server extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Reorder.setText("Reorder The Packets");
        ...
        ServerIP.setText("Enter the Server IP Address");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(Server, javax.swing.GroupLayout.DEFAULT_SIZE, 210, Short.MAX_VALUE)
    ...
    private void ServerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ServerActionPerformed
        ServerI=ServerIP.getText();
        Thread th = new Thread(){
         public void run()
         {             
                ReliableTransfer rt = new ReliableTransfer();
    ...
    private void StopServerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StopServerActionPerformed
        Thread th = new Thread(){
            public void run()
            {
                ReliableTransfer R1 =  new ReliableTransfer();
                R1.Stop_the_Server();
                dispose();
                System.exit(0);
            }
